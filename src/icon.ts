...
export class Icon extends LitElement {
    ...
    renderGraphic() {
        switch (this.icon) {
            ...
            case 'another-icon':
                return (
                    svg`<g><path d="M7.41 15.41l4.59-4.58 4.59 4.58 1.41-1.41-6-6-6 6z"/></g>`
                );
            case 'format-bold':
                return (svg`
            ...
            case 'format-italic':
                return (
                    svg`<g><path d="M10 4v3h2.21l-3.42 8h-2.79v3h8v-3h-2.21l3.42-8h2.79v-3z"></path></g>`
                );
            case 'format-underline':
                return (
                    svg`<g><path d="M12 17c3.31 0 6-2.69 6-6v-8h-2.5v8c0 1.93-1.57 3.5-3.5
            ...
            case 'format-align-right':
                return svg`<g><path d="M3 21h18v-2h-18v2zm6-4h12v-2h-12v2zm-6-4h18v-2h-18v2zm6-4h12v-2h-12v2zm-6-6v2h18v-2h-18z">
                </path></g>`;
            case 'add-box':
                return (
                    svg`<g><path d="M19 3h-14c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-14c0-1.1-.9-2-2-2zm-2
                10h-4v4h-2v-4h-4v-2h4v-4h2v4h4v2z"></path></g>`
            );
            case 'add':
                return (
                    svg`<g><path d="M19 13h-6v6h-2v-6h-6v-2h6v-6h2v6h6v2z"></path></g>`
                );
            case 'text-format':
                return 
                    svg`<g><path d="M5 17v2h14v-2h-14zm4.5-4.2h5l.9 2.2h2.1l-4.75-11h-1.5l-4.75
    ...
    _render() {
        ...
        let style = JsonToCssStyle({...styles});
        return (
            html`<svg viewBox="0 0 24 24" on-click={this.onClick}
